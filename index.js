 ...
 * Say goodbye
 */
bot.on(/покеда/gi, (ctx) => ctx.reply("До свидания"));
bot.on(/до свидания/gi, (ctx) => ctx.reply("Покеда"));

/**
 * Quakoosha
 */
bot.on(/Quakoosha/gi, (ctx) =>
...
bot
	.launch({ webhook: { domain: process.env.CYCLIC_URL, port: process.env.PORT } })
